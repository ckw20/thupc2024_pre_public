...
//			cout<<nw<<" ";
	...
	void solve()
	{
		...
		int testid=read(),op=0,n=1000000,q=5e5;
		//2 \sim 6
//		cout<<n<<"\n";
//		for(int i=1;i<=n;i++)cout<<rd(0,1);
//		puts("");
		// 7
//		string A;
//		const int D=66532;
...
//		cout<<n<<"\n";
//		for(int i=1;i<=n;i++)a[i]=(rd(0,2)!=0);
//		puts("");
//		for(int i=1;i<=1000000;i++)
//		{
//			int ty=rd(1,n-20),tl=__lg(i);
//			for(int j=tl;j>=0;j--)a[ty+tl-j]=i>>j&1;
//		}
...
//		puts("");
		...
		string A;
//		const int D=66532;
		for(int i=rd(1,1e6);i;i++)
		{
			string B;
			int len=__lg(i);
			for(int j=len;j>=0;j--)B+=('0'+(i>>j&1));
			if(siz(A)+siz(B)<=1e6)A.insert(rd(0,siz(A)),B);
			else break;
		}
		cout<<siz(A)<<"\n";
		cout<<A<<"\n"; //8 是 reverse  
...
//		if(is(2,6))n=500-rd(0,5),q=500;
//		if(is(5,8))n=5000-rd(0,5),q=5000;
//		if(is(9,12))n=5e5-rd(0,5),q=0;
//		if(is(13,16))n=5e5-rd(0,5),op=1;
//		if(is(17,20))n=5e5-rd(0,5);
//		cout<<n<<" "<<q<<"\n";
//		if(q==0)
//		{
//			if(testid&1)one(10000);
//			else two(10000);
//			return;
//		}
//		if(testid&1)one(q/rd(10,30));
//		else two(q/rd(10,30));
//		
//		if(op)
//		{
